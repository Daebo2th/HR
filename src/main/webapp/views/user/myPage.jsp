...
<div id="myInfo">
    ...
    <table class="main-table-1">
            ...
            <td rowspan="5" width="300px"> <!-- <img src="/assets/images/main_ps.jpg"> -->
                <form method="post" enctype="multipart/form-data" action="/upload.do" onsubmit="return validateForm()">
                    <div class="addImage" onclick="document.getElementById('imgInput').click()">
                        ...
                        <c:if test="${info.idto.sfile==null}"><img class="imgPreview" id="imgPreview" alt=""
                                                                   src="/assets/images/user.png"
                                                                   style="width: 200px; height:200px;"></c:if>
                        <c:if test="${info.idto.sfile!=null}"><img class="imgPreview" id="imgPreview" alt=""
                                                                   src="/upload/${info.idto.sfile}"
                                                                   style="width: 200px; height:200px; border: 2px solid black; border-radius: 100px;"></c:if>
        ...
        <tr>
            ...
            <td>${info.rank}</td>
            <th>권한타입</th>
            <td>${info.permission_type == 1?'최고 관리자':"사용자"}</td>
        </tr>
        <tr>
            <th>연차수</th>
            <td>${info.annual_num}</td>
            <th>입사일</th>
            <td><fmt:formatDate value="${info.hire_date}" pattern="yyyy-MM-dd"/></td>
            <th>퇴사일</th>
            <td><fmt:formatDate value="${info.departure_date}" pattern="yyyy-MM-dd"/></td>
        </tr>
    </table>
</div>
...
<script>
    ...
    function updateView(input) {
        ...
        let str = `
            ...
            <tr class="info-tr1">
               <th class="four">비밀번호</th>
               <td><input type="button" class="infoupdate" onclick="resetPwd('${info.email}')" value="초기화"></td>
            </tr>
         `;
