                    ...
                    <div class="modal_nav" id="tab-1" style="display: block;">
                        <form method="get" id="frm">
                            ...
                            <div class="bottom-btn">
                                <div class="right-btn">
                                    <button type="button" class="custom-btn btn-10" id="sendEmp">추가하기</button>
                            ...
                            <div class="bottom-btn">
                                <div class="right-btn plusbtn">
                                    <button type="button" id="career_table"
                                            class="custom-btn btn-10 btnplus">테이블 추가하기
                                    </button>
                                    <button class="custom-btn btn-10 btnplus" form="경력"
                                            onclick="sendCareer(this.form);">추가하기
                                    </button>
